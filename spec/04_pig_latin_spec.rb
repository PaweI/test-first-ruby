...
describe "#translate" do
  ...
  it "asserting that capitalized words are still capitalized" do
    s = translate("three quiet Green Monkees")
    s.should == "eethray ietquay Eengray Onkeesmay"
  end

  it "retain original punctuation" do
    s = translate("Yellow Submarine, Yellow Submarine!")
    s.should == "Ellowyay Ubmarinesay, Ellowyay Ubmarinesay!"
  end
end
